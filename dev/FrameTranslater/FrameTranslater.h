...
#define SUBFRAMES_NUM_SHIFT 4 // note this is +1 due to zero index eg. 7 -> 8, must be power of 2
#define SINGLE_FRAME_MASK 0b00001000 // mask to check single frame bit
