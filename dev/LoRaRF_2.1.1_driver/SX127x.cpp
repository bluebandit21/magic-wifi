...
{
    sx127x_setSPI(SpiObject, device);
...
void SX127x::_interruptTx(void)
{
    ...
    // detach interrupt
    sx127x_interruptDisable(LORA::SENDER); //Note: hardcoded!
...
void SX127x::_interruptRx()
{
    ...
    // detach interrupt
    sx127x_interruptDisable(LORA::RECEIVER); //Note: hardcoded!
